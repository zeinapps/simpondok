...
<div class="box box-info">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::open(['url' => 'admin/permission', 'method' => 'POST','class'=>'form-horizontal' , 'enctype'=>'multipart/form-data']) !!}
    {{ Form::token() }}
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="name" type="text" class="form-control" name="name" value="{{ isset($name) ? $name : old('name') }}" disabled="">
                @if ($errors->has('name'))
    ...
    <div class="box-footer">
        <button type="submit" class="btn btn-primary">
            ...
            <a class="btn btn-default" href="{{ route('permission.permission.index') }}">
                Kembali
            </a>
    </div>
