...
<div class="box box-info">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::open(['url' => 'admin/mapel', 'method' => 'POST','class'=>'form-horizontal' , 'enctype'=>'multipart/form-data']) !!}
    {{ Form::token() }}
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="kode" type="text" class="form-control" name="kode" value="{{ isset($kode) ? $kode : old('kode') }}" required autofocus>
                @if ($errors->has('kode'))
    ...
    <div class="box-footer">
        <button type="submit" class="btn btn-primary">
            ...
            <a class="btn btn-default" href="{{ route('permission.mapel.index') }}">
                Kembali
            </a>
    </div>
